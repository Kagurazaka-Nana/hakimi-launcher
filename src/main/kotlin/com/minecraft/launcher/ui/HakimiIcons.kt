 ...
 * 读取/解析失败或没有对应 SVG 时回退到 Material 图标（仅取矢量素材，非 Material 视觉层）。
 */
object HakimiIcons {
    // —— 使用项目 SVG 的图标 ——
    ...
    val Version: ImageVector = SvgIcons.load("ic_version", Icons.Filled.DataObject)

    // —— 无对应 SVG，使用 Material 矢量素材 ——
    ...
    val Launchpad: ImageVector = Icons.Filled.GridView
